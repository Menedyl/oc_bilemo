...
class LoadPhoneData extends AbstractFixture implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $phone1->setPicture('http://cdn.androidicecreamsandwich.de/wp-content/uploads/2017/03/samsung-galaxy-s8.jpg');
        ...
        $phone2->setPicture('http://cdn2.gsmarena.com/vv/pics/apple/apple-iphone-7-2.jpg');
        ...
        $phone3->setPicture('http://hwnpf26968.i.lithium.com/t5/image/serverpage/image-id/1499i8247A598894B1D0B/image-size/large?v=1.0&px=600');
        ...
        $phone4->setPicture('https://www.android4ar.com/wp-content/uploads/2016/09/Sony-Xperia-XZ.jpg');
